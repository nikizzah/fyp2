...
<section class="section">
   <div class="col-md-6 form-table">
		<form method="POST" action="/resethop">
         @if(Session::has('fail'))
         ...
         <a style='color:#c88f73'>Head of Program</a>
			...
			<div class="form-group" style='text-align:left'>
				<label for="hop_password">Current Password</label>
         ...
         <br><a style='color:#E4B7A0; text-decoration:underline; font-size:11px' href='hoplogin'>Login</a>
	   </form>
	</div>
</section>
   <!-- JS Plugins -->
