...
<body>
    ...
    <br>
        ...
        <br>
        @livewire('planning', ['advisee' => $advisee])
        <br>
    </section>
    ...
    <script>
        ...
        function handleDrop(e) {
            ...
            if (prerequisite === 'None' || prerequisite === 'none') {
                ...
                for (const row of prerequisiteTable) {
                    ...
                    if (prerequisites.includes(subjectCode)) {
                        ...
                        if (prerequisiteTableId <= targetTableId) {
                            // The target table after the table with the subject as a prerequisite
                ...
                // Iterate over the tables before the target table
                for (let i = targetTableIndex - 1; i >= 0; i--) {
                    ...
                    for (const row of prerequisitebfrRows) {
                        ...
                        if (prerequisites.includes(subjectCode)) {
                            ...
                            const errorMessage = 'Cannot drop subject. Prerequisite subject must be completed first.';
                                alert(errorMessage);
                                return;
                        }
                    }
